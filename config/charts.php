...
return [
    ...
    */
    'templates' => [
        'material' => [
            '#2196F3', '#F44336', '#FFC107', '#66CC00',
            '#009966', '#3399CC', '#003366', '#FF33CC',
            '#FF99CC', '#FF6600', '#FF6666', '#FF9900',
        ],
        'red-material' => [
...
//                   asset('public/plugins/jQuery/jquery-2.2.3.min.js'),
            ],
        ],
...
//                'https://cdn.rawgit.com/Mikhus/canvas-gauges/gh-pages/download/2.1.2/all/gauge.min.js',
                  asset('public/Report/gauge.min.js'),
            ],
        ],
...
//                'https://cdnjs.cloudflare.com/ajax/libs/chartist/0.10.1/chartist.min.js',
                    asset('public/Report/Chartist.min.js'),
            ],
            'styles' => [
//                'https://cdnjs.cloudflare.com/ajax/libs/chartist/0.10.1/chartist.min.css',
                    asset('public/Report/chartist.min.css'),
            ],
        ],
...
//                'https://static.fusioncharts.com/code/latest/fusioncharts.js',
                asset('public/Report/fusioncharts.js'),
                asset('public/Report/fusioncharts.theme.fint.js'),
...
//        ],
        ...
        'highcharts' => [
            ...
            'scripts' => [
                asset('public/Report/highcharts.js'),
                asset('public/Report/offline-exporting.js'),
                asset('public/Report/map.js'),
                asset('public/Report/data.js'),
                asset('public/Report/world.js'),
